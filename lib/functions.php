<?php require_once(__DIR__ . "/../IT490-PHP/connection.php");
$BASE_PATH = '/IT490Project/'; //This is going to be a helper for redirecting to our base project path since it's nested in another folder
